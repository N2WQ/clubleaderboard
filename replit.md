...
- **Contest Insights**: Homepage displays three insight boxes that adapt to selected leaderboard tab:
  - **Most Recent Logs**: Shows 5 most recent accepted submissions (always year-independent, regardless of tab selection). Displays callsign and contest key as clickable links. API: `/api/insights/recent-logs` returns latest 5 submissions ordered by submission date.
